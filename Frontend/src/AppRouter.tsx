...
import AdminForumTopicsPage from "./pages/AdminForumTopicsPage";
...
import TeacherCourseEditPage from "./pages/redesign/TeacherCourseEditPage";
import LearningPage from "./pages/redesign/LearningPage";
	...
	return (
		<BrowserRouter>
			<Routes>
				...
				<Route
					path="/quiz/:courseId/:lessonId/result"
					element={<QuizResultPage />}
				/>
				<Route
					path="/quiz/:courseId/:lessonId/review"
