...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({
	...
	return (
		<div
			className={`bg-white border-2 border-[#263D5B] rounded-[12px] overflow-hidden ${className}`}
		>
			...
			<div className="max-h-96 overflow-y-auto">
              ...
              `}
						>
							<div
								className={`p-2 rounded-[8px] ${getBgColor(notification.type)}`}
							>
