				...
				<div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
					<div>
						...
						<p className="text-gray-600 mt-2">
							Theo dõi danh sách học viên, tiến độ học và những trường hợp cần
							hỗ trợ.
						</p>
					</div>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
					<Card hoverable={false}>
						<div className="flex items-start justify-between gap-3">
							...
							<div className="p-3 rounded-xl bg-[#E8F6FC] text-[#49B6E5]">
						...
						<table className="w-full">
							<thead>
								<tr className="border-b-2 border-dashed border-[#E5E1DC] text-left">
									<th className="py-3 pr-4 font-['Inter', sans-serif] text-sm text-[#1C293C]">
										Học viên
									</th>
									<th className="py-3 pr-4 font-['Inter', sans-serif] text-sm text-[#1C293C]">
										Khóa học
									...
									<th className="py-3 font-['Inter', sans-serif] text-sm text-[#1C293C]">
										Trạng thái
									</th>
								</tr>
							</thead>
