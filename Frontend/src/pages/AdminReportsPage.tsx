import { Check, Search, TrendingUp, X } from "lucide-react";
...
export const AdminReportsPage: React.FC = () => {
	...
	const currentMonthRevenue =
		adminMonthRevenue.find((m) => m.month === "T7")?.revenue || 0;
	const prevMonthRevenue =
		adminMonthRevenue.find((m) => m.month === "T6")?.revenue || 1;
	const percentChange = (
	...
	return (
		<div className="max-w-7xl mx-auto w-full">
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
				<div className="bg-white border-2 border-[#1C293C] rounded-[16px] p-6 shadow-[3px_3px_0px_#E5E1DC] transition-all duration-200 ease-out overflow-visible">
					...
					<div className="mt-4 pt-4 border-t border-dashed border-[#E5E1DC]">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="font-['Inter', sans-serif] text-xl text-[#1C293C]">
									{formatPrice(totalRevenue)}
								</p>
							</div>
							<div className="text-right">
								<p className="text-xs text-gray-500">Học viên mới tháng này</p>
								<p className="font-['Inter', sans-serif] text-xl text-green-600">
									+124
								</p>
							</div>
						</div>
				...
				<Card className="p-6">
					...
					<p className="font-['Inter', sans-serif] text-sm text-green-600">
						+{percentChange}%
					</p>
				</Card>
