		...
		<div className="max-w-7xl mx-auto w-full">
				...
				<div className="flex gap-4">
					<div className="relative flex-1">
						...
						<input
							...
							className="w-full pl-10 pr-4 py-2 border-2 border-[#1C293C] rounded-[8px] font-['Inter', sans-serif]"
						/>
					</div>
					<select
						value={filterRole}
						onChange={(e) => setFilterRole(e.target.value)}
						className="px-4 py-2 border-2 border-[#1C293C] rounded-[8px] font-['Inter', sans-serif]"
					>
			...
			<div className="overflow-x-auto">
				<table className="w-full">
					<thead>
						<tr className="border-b-2 border-[#1C293C]">
							<th className="text-left py-3 px-4 font-['Inter', sans-serif] text-[#1C293C]">
								Người dùng
							</th>
							<th className="text-left py-3 px-4 font-['Inter', sans-serif] text-[#1C293C]">
								Email
							...
							<th className="text-right py-3 px-4 font-['Inter', sans-serif] text-[#1C293C]">
								Thao tác
							</th>
						</tr>
					</thead>
			...
			>
				<div className="space-y-4">
					<div>
						<label className="block text-sm font-['Inter', sans-serif] text-gray-600 mb-1">
							Tên đăng nhập *
						</label>
						<Input
							value={formData.ten_dang_nhap}
							onChange={(val) =>
								setFormData({ ...formData, ten_dang_nhap: val })
							}
					...
					{!editingUser && (
						<div>
							...
							<Input
								...
								onChange={(val) =>
									setFormData({ ...formData, mat_khau: val })
								}
